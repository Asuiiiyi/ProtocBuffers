...
template <> struct is_proto_enum< ::ColorPackage::Color> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ColorPackage::Color>() {
  return ::ColorPackage::Color_descriptor();
}
